 ...
 *
 * Compiled with MinGW64: x86_64-w64-mingw32-gcc -m64 -shared -O2 -std=c11 -o dxgw.dll dxgi_win7.c dxgi_win7.def -ldxgi -ld2d1 -loleaut32 -lgdi32 -luser32
...
/*             When OutputLogFile=1 in dxgw.ini, emits to the log file so that   */
