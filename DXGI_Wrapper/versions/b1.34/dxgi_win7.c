...
static HRESULT WrapSC_Create2_Impl(IUnknown *pReal, REFIID riid, void **ppOut, WrapSC **ppWrapOut, D3D12Interop *pInterop)
{
    WrapSC *w; HRESULT hr;
...
static HRESULT WrapSC_Create2(IUnknown *pReal, REFIID riid, void **ppOut, WrapSC **ppWrapOut, D3D12Interop *pInterop)
{
    ...
    hr = WrapSC_Create2_Impl(pReal, riid, ppOut, ppWrapOut, pInterop);
